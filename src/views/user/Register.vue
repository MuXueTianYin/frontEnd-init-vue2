    ...
    <a-form ref="formRegister" :form="form" id="formRegister">
      <a-form-item>
        <a-input
          ...
          v-decorator="['userAccount', {rules: [], validateTrigger: ['change', 'blur']}]"
        ></a-input>
      </a-form-item>
      ...
      <a-popover
        ...
        <a-form-item>
          <a-input-password
            ...
            v-decorator="['userPassword', {rules: [{ required: true, message: $t('user.password.required') }, { validator: this.handlePasswordLevel }], validateTrigger: ['change', 'blur']}]"
          ></a-input-password>
        </a-form-item>
      </a-popover>
      ...
      <a-form-item>
        <a-input-password
          ...
          v-decorator="['checkPassword', {rules: [{ required: true, message: $t('user.password.required') }, { validator: this.handlePasswordCheck }], validateTrigger: ['change', 'blur']}]"
        ></a-input-password>
      </a-form-item>
      <a-form-item>
        <a-button
